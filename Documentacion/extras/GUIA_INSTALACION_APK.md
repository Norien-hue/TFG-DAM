...
| La APK compilada | `ReciApp_Final\App_Movil\compilado\ReciApp-release.apk` | Ver GUIA_COMPILACION_APK.md para generarla |
...
& "$env:LOCALAPPDATA\Android\Sdk\platform-tools\adb.exe" install "ReciApp_Final\App_Movil\compilado\ReciApp-release.apk"

# Si ya tienes una version anterior instalada, usa -r para reemplazar
& "$env:LOCALAPPDATA\Android\Sdk\platform-tools\adb.exe" install -r "ReciApp_Final\App_Movil\compilado\ReciApp-release.apk"
```
